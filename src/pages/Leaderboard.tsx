            ...
            {entries.map((entry, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`glass-card rounded-xl p-4 flex items-center gap-4 ${isMe ? 'ring-2 ring-primary' : ''}`}
                >
                  <div className="w-8 text-center font-bold text-muted-foreground">
                    {i < 3 ? rankIcons[i] : <span>{i + 1}</span>}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 text-xs text-muted-foreground">
                      <span className="flex items-center gap-1"><Zap size={12} /> {entry.total_xp} XP</span>
